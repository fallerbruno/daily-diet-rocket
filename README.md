...
# Faça o clone do repotório
  git clone https://github.com/fallerbruno/daily-diet-rocket
...
Você deve criar os arquivos de configurações de acordo com os exemplos.
...
- Listar todas refeições de todos os usuários
```bash
GET /meal/meals
```
